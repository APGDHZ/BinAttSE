...
class DataGenerator:
    def __init__(self, mode, args):
        if mode != "train" and mode != "valid" and mode != "test" and mode != "objective_test":
    ...
    def fetch(self):
        ...
        if self.mode == "train":
            ...
            dataset = dataset.shuffle(2000, reshuffle_each_iteration=True, seed=42)
    ...
    def _encode(self, mode):
        ...
        if self.mode == "objective_test":
            print("\nSerializing testing data for objective evaluation...\n")
        ...
        if self.mode != "objective_test":
            ...
            for mix_filename, target_filename in tqdm(zip(mix_filenames,
                ...
                mix, _ = librosa.load(mix_filename, sr=self.sample_rate, mono=False)
                clean, _ = librosa.load(target_filename, sr=self.sample_rate, mono=False)
